  ...
  function engine() {
    ...
    function loadLibrary(deviceId, libraryLocation, locationPath, deviceModelName, uaBrowserName) {
      ...
      Module = {
        ...
        instantiateWasm: function instantiateWasm(importObject, successCallback) {
          ...
          if (wasmJSVersion !== "4.6.0") {
            console.error(
              "The Scandit SDK Engine library JS file found at ".concat(jsURI, " seems invalid: ") +
                "expected version doesn't match (received: ".concat(wasmJSVersion, ", expected: ", "4.6.0", "). ") +
    ...
    function getLibraryLocationURIs(libraryLocation) {
      ...
      if (/^https?:\/\/([^\/.]*\.)*cdn.jsdelivr.net\//.test(libraryLocation)) {
        libraryLocation = "https://cdn.jsdelivr.net/npm/scandit-sdk@4.6.0/build/";
        cdnURI = true;
      } else if (/^https?:\/\/([^\/.]*\.)*unpkg.com\//.test(libraryLocation)) {
        libraryLocation = "https://unpkg.com/scandit-sdk@4.6.0/build/";
        cdnURI = true;
      }
      ...
      return {
        jsURI: "".concat(libraryLocation, "scandit-engine-sdk.min.js?v=4.6.0"),
        wasmURI: "".concat(libraryLocation, "scandit-engine-sdk.wasm?v=4.6.0")
      };
    }
      ...
      function verifyResponseData(responseData) {
        ...
        if (crypto.subtle != null && typeof crypto.subtle === "object" && typeof crypto.subtle.digest === "function") {
          crypto.subtle.digest("SHA-256", responseData).then(function(hash) {
            ...
            if (hashString !== "5ce03bc226b3fcfc996f7277152f93b19ec6301e760354c4cf40881cd24404e8") {
              console.error(
                "The Scandit SDK Engine library WASM file found at ".concat(wasmURI, " seems invalid: ") +
                  ...
                  "expected: ".concat("5ce03bc226b3fcfc996f7277152f93b19ec6301e760354c4cf40881cd24404e8", "). ") +
                  "Please ensure the correct Scandit SDK Engine file (with correct version) is retrieved."
              );
            }
          });
      ...
      createClass(
        ...
        [
          ...
          },
          {
            ...
            value: (function() {
              var _scheduleNextVideoProcessing = asyncToGenerator(
                /*#__PURE__*/
                regenerator.mark(function _callee6(processingStartTime) {
              ...
              function scheduleNextVideoProcessing(_x4) {
          ...
          },
          {
            ...
            value: (function() {
              var _processVideoFrame = asyncToGenerator(
                /*#__PURE__*/
                regenerator.mark(function _callee7(highQualitySingleFrameMode) {
              ...
              function processVideoFrame(_x5) {
