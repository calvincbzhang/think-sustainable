...
dl.tsd-comment-tags dt[data-tag="deprecated"] {
  color: #eba800;
  border: 1px solid #eba800;
}
dl.tsd-comment-tags dt[data-tag="asmemberof"],
dl.tsd-comment-tags dd[data-tag="asmemberof"] {
  display: none;
}

.tsd-panel[data-tags~="deprecated"] {
  color: #808080;
}
.tsd-panel[data-tags~="deprecated"] a {
  color: #67c0ff;
}
