...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/barcodePickerGui.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/lib</a> barcodePickerGui.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">93.4% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>368/394</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">82.96% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>112/135</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>361/385</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L736'></a><a href='#L736'>736</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">13x</span>
...
&nbsp;
  public setVideoFit(objectFit: BarcodePicker.ObjectFit): void {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.singleImageMode) {
...
&nbsp;
  public getVideoImageData(): Uint8ClampedArray | undefined {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.singleImageMode) {
...
<span class="branch-1 cbranch-no" title="branch not covered" >        this.videoImageCanvasContext.canvas.width &lt;= 2 </span>||
<span class="branch-2 cbranch-no" title="branch not covered" >        this.videoImageCanvasContext.canvas.height &lt;= 2</span>
      ) {
        return undefined;
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.videoImageCanvasContext.drawImage(this.videoElement, 0, 0);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.videoImageCanvasContext.getImageData(</span>
      0,
      0,
...
&nbsp;
    this.videoElement.addEventListener("canplay", <span class="fstat-no" title="function not covered" >() =&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >        this.resizeIfNeeded(true);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        window.objectFitPolyfill(this.videoElement);</span>
      }, 0);
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.videoImageCanvasContext.canvas.width = this.videoElement.videoWidth;</span>
<span class="cstat-no" title="statement not covered" >      this.videoImageCanvasContext.canvas.height = this.videoElement.videoHeight;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.scanner.applyImageSettings({</span>
...
&nbsp;
  private checkAndRecoverPlayback(): void {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (
      this.cameraManager != null &amp;&amp;
      this.cameraManager.activeCamera != null &amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >      this.videoElement != null </span>&amp;&amp;
<span class="branch-3 cbranch-no" title="branch not covered" >      this.videoElement.srcObject != null</span>
    ) {
<span class="cstat-no" title="statement not covered" >      if (!(&lt;MediaStream&gt;this.videoElement.srcObject).active) {</span>
<span class="cstat-no" title="statement not covered" >        this.cameraManager.reinitializeCamera();</span>
      } else {
<span class="cstat-no" title="statement not covered" >        this.playVideo();</span>
      }
    }
  }
&nbsp;
  ...
  private cameraUploadFile(): void {
    ...
    if (files != null &amp;&amp; files.length !== 0) {
      ...
      fileReader.onload = () =&gt; {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (fileReader.result != null) {
          image.onload = this.cameraUploadImageLoad.bind(this, image);
          image.onprogress = event2 =&gt; {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (event2.lengthComputable) {
              const progress: number = Math.round((event2.loaded / event2.total) * 20) * 5;
              <span class="missing-if-branch" title="else path not taken" >E</span>if (progress &lt;= 100) {
...
&nbsp;
  private setupCameraSwitcher(): void {
    ...
    ["touchstart", "mousedown"].forEach(eventName =&gt; {
      this.cameraSwitcherElement.addEventListener(eventName, <span class="fstat-no" title="function not covered" >async e</span>vent<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" > =&gt; {</span></span>
        if (<span class="cstat-no" title="statement not covered" >this.</span>cameraManager != null) {
          const <span class="cstat-no" title="statement not covered" >cameraManager: CameraManager = this.cameraManager;</span>
<span class="cstat-no" title="statement not covered" >          event.preventDefault();</span>
          try {
            ...
            const <span class="cstat-no" title="statement not covered" >newCameraIndex: number =</span>
              (cameras.findIndex(<span class="fstat-no" title="function not covered" >camera </span>=&gt; {
<span class="cstat-no" title="statement not covered" >                return (</span>
                  camera.deviceId ===
                ...
                1) %
              cameras.length;
<span class="cstat-no" title="statement not covered" >            cameraManager</span>
...
&nbsp;
  private setupTorchToggler(): void {
    ...
    ["touchstart", "mousedown"].forEach(eventName =&gt; {
      this.torchTogglerElement.addEventListener(eventName, <span class="fstat-no" title="function not covered" >event </span>=&gt; {
<span class="cstat-no" title="statement not covered" >        if (this.cameraManager != null) {</span>
<span class="cstat-no" title="statement not covered" >          event.preventDefault();</span>
<span class="cstat-no" title="statement not covered" >          this.cameraManager.toggleTorch();</span>
        }
      });
    });
  }
&nbsp;
  private showScanditLogo(hideLogo: boolean, licenseFeatures?: { hiddenScanditLogoAllowed?: boolean }): void {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (
      hideLogo &amp;&amp;
<span class="branch-1 cbranch-no" title="branch not covered" >      licenseFeatures != null </span>&amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >      licenseFeatures.hiddenScanditLogoAllowed != null </span>&amp;&amp;
<span class="branch-3 cbranch-no" title="branch not covered" >      licenseFeatures.hiddenScanditLogoAllowed</span>
    ) {
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
