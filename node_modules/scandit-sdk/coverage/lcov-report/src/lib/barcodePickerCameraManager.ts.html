...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/barcodePickerCameraManager.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/lib</a> barcodePickerCameraManager.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">93.95% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>326/347</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">86.47% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>179/207</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>309/329</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L769'></a><a href='#L769'>769</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">13x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { BarcodePickerGui } from "./barcodePickerGui";
...
&nbsp;
  public async setupCameras(): Promise&lt;void&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.cameraInitializationPromise != null) {
<span class="cstat-no" title="statement not covered" >      return this.cameraInitializationPromise;</span>
    }
&nbsp;
...
&nbsp;
  public applyCameraSettings(cameraSettings?: CameraSettings): Promise&lt;void&gt; {
    this.selectedCameraSettings = cameraSettings;
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.activeCamera == null) {
<span class="cstat-no" title="statement not covered" >      return Promise.reject(new CustomError(BarcodePickerCameraManager.noCameraErrorParameters));</span>
    }
&nbsp;
    return this.initializeCameraWithSettings(this.activeCamera, cameraSettings);
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  public r</span>einitializeCamera(): void {
<span class="cstat-no" title="statement not covered" >    if (this.activeCamera != null) {</span>
<span class="cstat-no" title="statement not covered" >      this.initializeCameraWithSettings(this.activeCamera, this.activeCameraSettings).catch(this.triggerFatalError);</span>
    }
  }
&nbsp;
  public async initializeCameraWithSettings(camera: Camera, cameraSettings?: CameraSettings): Promise&lt;void&gt; {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.cameraInitializationPromise != null) {
<span class="cstat-no" title="statement not covered" >      existingCameraInitializationPromise = this.cameraInitializationPromise;</span>
    }
&nbsp;
...
&nbsp;
  public async setTorchEnabled(enabled: boolean): Promise&lt;void&gt; {
    if (
      ...
      if (<span class="missing-if-branch" title="if path not taken" >I</span>videoTracks.length !== 0 &amp;&amp; typeof videoTracks[0].applyConstraints === "function") {
...
&nbsp;
      initialCameraAccessPromise = new Promise(async resolve =&gt; {
        try {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (this.mediaStream != null) {
            const videoTracks: MediaStreamTrack[] = this.mediaStream.getVideoTracks();
            <span class="missing-if-branch" title="else path not taken" >E</span>if (videoTracks.length !== 0) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private v</span>ideoTrackUnmuteRecovery(): void {
<span class="cstat-no" title="statement not covered" >    this.reinitializeCamera();</span>
  }
&nbsp;
  ...
  private async initializeCameraAndCheckUpdatedSettings(
    ...
    try {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (
        ...
        (<span class="branch-1 cbranch-no" title="branch not covered" >this.selectedCameraSettings == null </span>||
<span class="branch-2 cbranch-no" title="branch not covered" >          this.activeCameraSettings == null </span>||
          (&lt;(keyof CameraSettings)[]&gt;<span class="branch-3 cbranch-no" title="branch not covered" >Object.keys(this.selectedCameraSettings)).some(<span class="fstat-no" title="function not covered" >cameraSettingsProperty </span>=&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >        this.activeCameraSettings = this.selectedCameraSettings;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        return this.initializeCameraAndCheckUpdatedSettings(camera, resolutionFallbackLevel);</span>
      }
    } finally {
...
&nbsp;
  private async handleCameraInitializationError(
    ...
    if (
      <span class="missing-if-branch" title="else path not taken" >E</span>error.message === "Invalid constraint" ||
      // tslint:disable-next-line:no-any
      (error.name === "OverconstrainedError" &amp;&amp; (&lt;any&gt;<span class="branch-2 cbranch-no" title="branch not covered" >error).constraint === "deviceId")</span>
    ) {
      // Camera might have changed deviceId: check for new cameras with same label and type but different deviceId
      const <span class="cstat-no" title="statement not covered" >cameras: Camera[] = <span class="cstat-no" title="statement not covered" >await CameraAccess.getCameras();</span></span>
      const <span class="cstat-no" title="statement not covered" >newCamera: Camera | undefined = cameras.find(<span class="fstat-no" title="function not covered" >currentCamera </span>=&gt; {</span>
<span class="cstat-no" title="statement not covered" >        return (</span>
...
<span class="cstat-no" title="statement not covered" >      if (newCamera == null) {</span>
<span class="cstat-no" title="statement not covered" >        return this.retryInitializeCameraIfNeeded(camera, resolutionFallbackLevel, resolve, reject, error);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        return this.initializeCamera(newCamera, resolutionFallbackLevel)</span>
          .then(resolve)
          .catch(reject);
      }
    }
...
&nbsp;
  private initializeCamera(camera: Camera, resolutionFallbackLevel: number = 0): Promise&lt;void&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (camera == null) {
<span class="cstat-no" title="statement not covered" >      return Promise.reject(new CustomError(BarcodePickerCameraManager.noCameraErrorParameters));</span>
    }
    this.stopStream();
...
&nbsp;
    return new Promise(async (resolve, reject) =&gt; {
      try {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof stream.getTracks()[0].getSettings === "function") {
...
<span class="cstat-no" title="statement not covered" >            if (resolutionFallbackLevel === 6) {</span>
...
<span class="cstat-no" title="statement not covered" >              return this.initializeCamera(camera, resolutionFallbackLevel + 1)</span>
                .then(resolve)
                .catch(reject);
            }
          }
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.tapToFocusEnabled) {
          this.enableTapToFocusListeners();
        }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.pinchToZoomEnabled) {
          this.enablePinchToZoomListeners();
        }
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Tue Oct 29 2019 14:02:23 GMT+0100 (GMT+01:00)
</div>
</div>
